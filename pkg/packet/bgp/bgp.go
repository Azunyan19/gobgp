...
func (l *LsSrv6SIDNLRI) String() string {
	...
	return fmt.Sprintf("SRv6SID { LOCAL_NODE: %s SRv6_SID: %v MULTI_TOPO_IDs: %v, SERVICE_CHAINING: %v, OPAQUE_METADATA: %v}", local, srv6SID.String(), multiTopo.String(), serviceChaining.String(), opaqueMetadata.String())
}
